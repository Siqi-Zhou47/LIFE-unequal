...
private:
	...
	double I;						// Second moment area
	double c,s; // cos/sin of current element orientation

	// Structural properties
	double E;						// Youngs modulus
	double rho;						// Material density
	
	int elemID;   // 元素编号，用于调试打印
	...
	// local/global matrices (6x6)
	std::array<std::array<double,elementDOFs>,elementDOFs> Klocal;
	std::array<std::array<double,elementDOFs>,elementDOFs> Kglobal;
	std::array<std::array<double,elementDOFs>,elementDOFs> Mlocal; // optional if you want local mass
	std::array<double,elementDOFs> Flocal;
